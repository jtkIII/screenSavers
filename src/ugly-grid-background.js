...
const material = new THREE.ShaderMaterial({
  ...
  fragmentShader: `
    ...
    void main() {
        ...
        vec2 warp;
        warp.x = fbm(uv * 1.4 + warpTime);
        warp.y = fbm(uv * 1.4 - warpTime);

        uv += (warp - 0.5) * 0.22;
        uv += sin(uv.yx * 7.0 + baseTime * 0.25) * 0.012;
        ...
        field += fbm(uv * 3.2 + noiseTime) * 0.32;
        ...
        float grain = hash(gl_FragCoord.xy + baseTime) * 0.025;
        col += grain;
